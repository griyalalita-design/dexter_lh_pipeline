...
METABASE_CONFIG = {
    "lh": {
        ...
        "cs_iv": {
            ...
            "shipper_params_template": {
                "shopee_lazada": [{"id": "586a906e-a676-432c-b1d8-dc3b098bcc3a","type": "string/contains","value": ["216977"],"target": ["dimension", ["template-tag", "sf_parent_acc_id_coalesce"]],"options": {"case-sensitive": False},},],
