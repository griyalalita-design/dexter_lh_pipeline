...
METABASE_CONFIG = {
    "lh": {
        ...
        # "lnd_b2b_all_b2c_cc": {
        #     "url": "https://metabase.ninjavan.co/api/card/44744/query/json",
        #     "report_type": "lh",
        #     "common_params_template": [
        #       {"id":"458aa3b7-1c44-ce99-badb-176ad6013196","type":"category","value":["month"],"target":["variable",["template-tag","aggr"]]},
        #       {"id":"6954221a-2bb3-e6ff-0fdd-22eb3a2960ab","type":"date/single","value":"start_date","target":["variable",["template-tag","start"]]},
        #       {"id":"ce4438d1-ebcb-89c6-1997-cbbc50c70402","type":"date/single","value":"end_date","target":["variable",["template-tag","end"]]},
        #       {"id":"b2c822b6-27f4-3fca-5f1d-a7291f9b102e","type":"category","value":["LAND_HAUL"],"target":["dimension",["template-tag","shipment_type"]]}
        #     ]
        # },
